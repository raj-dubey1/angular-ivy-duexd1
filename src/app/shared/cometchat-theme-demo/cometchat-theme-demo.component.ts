...
import { CometChatTheme, fontHelper, Palette } from '@cometchat-pro/angular-ui-kit';
...
public image:string="https://data-us.cometchat.io/assets/images/avatars/ironman.png"
  ...
  public demotheme :CometChatTheme = new CometChatTheme({
    palette: new Palette({
  
      accent900:{
        dark:"rgb(55, 237, 237)",
        light:"rgb(55, 237, 237)"
      },
      background:{
        light:"rgb(217 164 245 / 61%)",
        dark:"rgb(217, 164, 245)"
      }
    })
  })
  ...
  redirect(name:string){
    if(this.activeTab == "Default"){
      ...
      this.cometchatService.theme = this.demotheme
